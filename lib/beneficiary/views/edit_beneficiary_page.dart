...
class EditBeneficiaryPage extends StatefulWidget {
  EditBeneficiaryPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "sf_editbeneficiaryScreen_editbeneficiaryTitle",
 ...
 SizedBox(
               ...
               FlatButton(
                ...
                child: Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.save_outlined, color: Theme.of(context).colorScheme.onBackground,),
                    Padding(
                      padding: const EdgeInsets.only(left: 10),
                      child: Text(
                        "sf_editbeneficiaryScreen_editbeneficiaryButton1",
